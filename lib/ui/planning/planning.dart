              ...
              Column(
                ...
                children: [
                  ...
                  CardPlanning(
                    ...
                    categories_4: 'Jeune 13 à 17 ans',
                    jour_5: 'Mercredi : ',
                  ...
                  CardPlanning(
                    ...
                    categories_2: 'Adultes et à partir de 15 ans',
                  ),
                  CardPlanning(
                    title: 'Zen Moving ',
                    jour_1: 'Mercredi :',
                  ...
                  CardPlanning(
                    ...
                    categories_1: '12-15 ans à (16h15) / adultes à (17h45)',
                  ),
                  CardPlanning(
                    title: 'Yoga',
                    jour_1: 'Mardi :',
                  ...
                  Text(
                    "Adhésion au club : 35€ l'année.",
                    style: textStyleText(context)
                        .copyWith(fontSize: calculatedFontSize),
                  ),
                  Text(
                    "Cotisation annuelle club : ",
                    style: textStyleText(context)
                        .copyWith(fontSize: calculatedFontSize),
                  ),
                  Text(
                    " selon l'âge et le lieu de domicile.",
                    style: textStyleText(context)
                        .copyWith(fontSize: calculatedFontSize),
                  ),
                  Text(
                    "Seclinois :  entre 52 et 135€ .",
                    style: textStyleTextAccueil(context),
                  ),
                  Text(
                    "non seclinois :  entre 67 et 140€.",
                    style: textStyleTextAccueil(context),
                  ),
                  Text(
                    "Reduction familles : 20% sur la totalité.",
                    style: textStyleTextAccueil(context)
