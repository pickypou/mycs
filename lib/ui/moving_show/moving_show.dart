                ...
                child: Column(
                  ...
                  children: [
                    Align(
                      ...
                      child: Text("Moving Show", style: titleStyleLarge(context),),
                    ),

                    const SizedBox(height: 20,),
                    ImgMoving(),
                    const SizedBox(height: 20,),
                    Text("Sport d'expression, le Moving se montre et permet à celles et ceux qui le souhaitent de se dépasser par l'apprentissage et la construction de suite (chorégraphie) de Moving ajoutant aux qualités du Moving, le travail en groupe et les représentations sur scène.",
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Align(
                      alignment: Alignment.center,
                      child: Text("Moving Show", style: titleStyleMedium(context),),
                    ),
