              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Sport d'expression, Sport d'exception",style: textStyleTextAccueil(context).copyWith(fontSize: size.width/27, fontWeight: FontWeight.normal)),
                    Text("Moving, Sport, Art et Technique", style: textStyleTextAccueil(context).copyWith(fontSize: size.width/27, fontWeight: FontWeight.normal),),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 15,),
                    Text("Sport d'expression, Sport d'exception",style: titleStyleSmall(context)),
